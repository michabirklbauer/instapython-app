...
if __name__ == '__main__':
	...
	if gui_mode:
		...
		if action == "instabot":
			...
			help = "Available methods:\n<instabot> channel api_token rtime stime debugging_mode(True/False) user_id*\n<getuserid> username\n<getusername> userid\n<getmediacount> userid\n<getprofilepic> userid download(True/False)\n<getnewpost> userid download(True/False)\n<getmedia> postURL\n<getstories> userid download(True/False)\n<instaview> path\n<loadresult>\n<getprivacysetting> userid\n"
			print(help)
		else:
